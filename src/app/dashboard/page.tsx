...
export default function DashboardPage() {
  ...
  const lastEntryDate =
    filteredEntries.length > 0
      ? new Date(
          Math.max(
            ...filteredEntries.map((e) => new Date(e.created_at).getTime())
          )
        ).toLocaleDateString()
      : "--";
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 text-center">
            <svg
              className="w-8 h-8 text-red-600 dark:text-red-400 mx-auto mb-3"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              ...
              {filteredEntries.length === 1 ? "entry" : "entries"} • Last
              updated today
            </p>
          </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <div className="relative">
                  ...
                  {showFilterOptions && (
                    <div className="absolute right-0 mt-1 w-48 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10">
                      {(["all", "recent", "lastWeek"] as FilterOption[]).map(
                        (option) => (
                          <button
                            key={option}
                            onClick={() => {
                ...
                <div className="relative">
                  ...
                  {showSortOptions && (
                    <div className="absolute right-0 mt-1 w-48 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10">
                      {(["newest", "oldest", "title"] as SortOption[]).map(
                        (option) => (
                          <button
                            key={option}
                            onClick={() => {
